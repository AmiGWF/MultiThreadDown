package com.wudu.muldown.service;
...
import com.wudu.downlibrary.DownloadRequest;
import com.wudu.downlibrary.util.L;
import com.wudu.muldown.R;
import com.wudu.muldown.entity.AppInfo;
import com.wudu.muldown.util.Utils;
...
public class DownloadService extends Service {
    ...
    public static final String ACTION_DOWNLOAD_BROAD_CAST = "com.wudu.muldown:action_download_broad_cast";

    public static final String ACTION_DOWNLOAD = "com.wudu.muldown:action_download";

    public static final String ACTION_PAUSE = "com.wudu.muldown:action_pause";

    public static final String ACTION_CANCEL = "com.wudu.muldown:action_cancel";

    public static final String ACTION_PAUSE_ALL = "com.wudu.muldown:action_pause_all";

    public static final String ACTION_CANCEL_ALL = "com.wudu.muldown:action_cancel_all";
    ...
    private void download(final int position, final AppInfo appInfo, String tag) {
        if(!mDownloadDir.exists()){
            Log.d("TAG","service download dir not exists");
